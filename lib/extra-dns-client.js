/**
 * Access to Extra PDNS router. Use as example
 */
const request = require('request');

module.exports = class ExtraPDNS {
    /**
     ...
     * @param {Integer} ttl
     */
    createZone(zone, ip_address, ttl) {
        return this.query('/', {name:zone, ip_address, ttl}, 'POST')
    }
    ...
    getRecordsByType(zone, type) {
        return this.query('/' + zone + '/records/' + type, {}, 'GET');
    }
    
    getRecord(zone, type, name) {
        return this.query('/' + zone + '/records/' + type + '/' + name, {}, 'GET');
    }
